...
public class Level1Controller extends Round5Controller implements Initializable, TimerInterface {
    ...
    private void setData() {
        ...
        String timeLimit_zh = "限时" + Main.R5L1_DATA.TIME_LIMIT + "分钟";
        String timeLimit_en = "Time Limit: " + Main.R5L1_DATA.TIME_LIMIT + (Main.R5L1_DATA.TIME_LIMIT > 1 ? " minutes" : " minute");
        ...
        String timerLabel = Main.R5L1_DATA.TIME_LIMIT + ":00";
    ...
    public void takeNotice() {
        writeToServer(Constants.C2S_R5L1_ANS, packageAnswers());
        hide();
