...
public class DataCollection implements DataCollectionInterface {
    private Node head; // the first node in the collection
    private Node selected; // the current selected node in the collection
    private Node userSelected; // the last node that was selected by the user
    ...
    private class Node {
        private Object data; // The student information
